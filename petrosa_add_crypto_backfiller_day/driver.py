...
logging.warning('Connecting to db to look for current_klines updates in the last current_klines_period')
...
for symbol in symbols_last_period:
    ...
    logging.warning('Size of the long tail: ' + str(len(item_list)) + ' for symbol ' + symbol)
